  ...
  $( function($){
    var quizMulti = {
      multiList:[
        { ques: "What is the name of the national anthem?", ans: "The Star-Spangled Banner", ansSel: [ "God Bless the U.S.A.", "My Country 'Tis of Thee", "America the Beautiful" ] },
        { ques: "What is the capital of the United States?", ans: "Washington, D.C.", ansSel: [ "Boston, MA", "New York, NY", "Philadelphia, PA" ] },
        { ques: "When is the last day you can send in federal income tax forms?", ans: "April 15", ansSel: [ "July 4", "March 15", "May 15" ] },
        { ques: "What do we call the first 10 amendments to the Constitution?", ans: "The Bill of Rights", ansSel: [ "The Emancipation Proclamation", "The Articles of Confederation", "The Federalist Papers" ] },
        { ques: "How many original states were there?", ans: "13", ansSel : [ "50", "25", "2" ] },
        { ques: "How many changes or amendments are there to the Constitution?", ans: "27", ansSel: [ "5", "100", "45" ] },
        { ques: "In what year was the Constitution written?", ans: "1787", ansSel: [ "1492", "1801", "1645" ] },
        { ques: "What is the minimum voting age in the United States?", ans: "18", ansSel: [ "21", "16", "28" ] },
        { ques: "What kind of government does the United States have?", ans: "Democracy", ansSel: [ "Socialist", "Republican", "Communist" ] },
        { ques: "Who becomes the President of the United States if the President AND Vice President should die?", ans: "Speaker of the House", ansSel: [ "An election is held","The Secretary of Defense", "The Supreme Court appoints someone" ] }
      ]
    };

    var options = {
      title: "Constitution USA Quiz",
      intro: "How many questions can you answer about the constitution of the United States?",
      numOfQuizQues: 10,
      ...
      random: true,
      review: false,
      statusUpdate: function( info, $quiz ){
        $(".q-help").hide();
      }
    };

    // Initialize the quiz in the container div
